...
/**
 * Sends anonymous metrics data to HouziExtension servers.
 *
 * <p><b>Usage example:</b>
 * <pre>{@code
 * MetricsSender metricsSender = houzicorePulse.get(MetricsSender.class);
 *
 * MetricsDTO metrics = ...;
 *
...
public class MetricsSender {
    ...
    private static final String FLECTONEPULSE_API_URL = "https://houzicore.net/api/pulse/metrics";

    private final Gson gson;

    /**
     * Sends metrics data to HouziExtension API.
