...
import com.houzicore.extension.config.setting.CooldownPermissionSetting;
import com.houzicore.extension.config.setting.PermissionSetting;
import com.houzicore.extension.config.setting.SoundPermissionSetting;
import com.houzicore.extension.util.constant.AdventureTag;

import java.util.Map;

/**
 * Configuration for permissions in HouziExtension.
...
public record Permission(
    ...
    public record Command(
            ...
            @JsonPropertyDescription(" https://houzicore.net/pulse/docs/command/afk")
            Afk afk,
    ...
    public record Message(
        ...
        public record Format(
            ...
            public record FColor(
                    String name,
                    Permission.Type type,
                    Map<com.houzicore.extension.model.FColor.Type, PermissionEntry> colors
            ) implements PermissionSetting {
            }
