...
import com.houzicore.extension.platform.registry.CacheRegistry;
...
public abstract class PlatformInjector extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(HouziExtensionAPI.class).asEagerSingleton();
...
//            Arrays.stream(packs)
//                    .map(Package::getName)
//                    .filter(string -> string.contains("com.houzicore.extension.library"))
//                    .sorted()
