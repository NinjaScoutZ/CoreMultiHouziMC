...
import com.houzicore.extension.util.constant.*;
...
public class FileMigrator {
    ...
    public FilePack migration_1_4_3(FilePack files) {
        ...
        if (update.name().equals("houziextension.module.message.op")) {
            files = files.withPermission(files.permission().withMessage(files.permission().message().withUpdate(files.permission().message().update()
                    .withName("houziextension.module.message.update.sound")
                    .withSound(new Permission.PermissionEntry("houziextension.module.message.update.sound", Permission.Type.TRUE))))
            );
        }
    ...
    public FilePack migration_1_6_0(FilePack files) {
        ...
        settings.put(SettingText.CHAT_NAME.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.chat_name", Permission.Type.TRUE));
        settings.put("FCOLOR_" + FColor.Type.SEE.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.fcolor_see", Permission.Type.TRUE));
        settings.put("FCOLOR_" + FColor.Type.OUT.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.fcolor_out", Permission.Type.OP));
        settings.put(ModuleName.MESSAGE_AFK.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.afk", Permission.Type.TRUE));
        settings.put("ADVANCEMENT", new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.advancement", Permission.Type.TRUE));
        settings.put(ModuleName.MESSAGE_CHAT.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.chat", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_ANON.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_anon", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_BALL.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_ball", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_BROADCAST.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_broadcast", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_COIN.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_coin", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_DICE.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_dice", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_DO.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_do", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_MAIL.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_mail", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_ME.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_me", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_POLL.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_poll", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_ROCKPAPERSCISSORS.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_rockpaperscissors", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_STREAM.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_stream", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_TELL.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_tell", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_TICTACTOE.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_tictactoe", Permission.Type.TRUE));
        settings.put(ModuleName.COMMAND_TRY.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.command_try", Permission.Type.TRUE));
        settings.put("DEATH", new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.death", Permission.Type.TRUE));
        settings.put(ModuleName.INTEGRATION_DISCORD.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.from_discord_to_minecraft", Permission.Type.TRUE));
        settings.put(ModuleName.INTEGRATION_TELEGRAM.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.from_telegram_to_minecraft", Permission.Type.TRUE));
        settings.put(ModuleName.INTEGRATION_TWITCH.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.from_twitch_to_minecraft", Permission.Type.TRUE));
        settings.put(ModuleName.MESSAGE_JOIN.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.join", Permission.Type.TRUE));
        settings.put(ModuleName.MESSAGE_QUIT.name(), new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.quit", Permission.Type.TRUE));
        settings.put("SLEEP", new Permission.Command.Chatsetting.SettingItem("houziextension.module.command.chatsetting.sleep", Permission.Type.TRUE));
