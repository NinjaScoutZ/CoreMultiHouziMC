...
import com.houzicore.shared.minecraft.game.classcombat.Class.ClientClass;
import com.houzicore.shared.minecraft.game.classcombat.Class.IPvpClass;

import com.houzicore.arcade.nautilus.game.arcade.ArcadeManager;
import com.houzicore.arcade.nautilus.game.arcade.kit.ChampionsKit;
...
public class KitRanger extends ChampionsKit
{
	...
	{
		super(manager, GameKit.CHAMPIONS_ARCHER);
	}
