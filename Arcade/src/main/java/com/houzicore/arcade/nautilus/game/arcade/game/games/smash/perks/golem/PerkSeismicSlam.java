...
public class PerkSeismicSlam extends SmashPerk
{
	...
	{
		this("Seismic Slam", 0, 0, 0, 0, 0);
	}

	public PerkSeismicSlam(String name, long cooldown, long time, int damage, int radius, float knockbackMagnitude)
	{
	...
	public void leap(PlayerInteractEvent event)
	{
		...
		if (!player.getInventory().getItemInMainHand().getType().name().endsWith("_SHOVEL") || !hasPerk(player) || !Recharge.Instance.use(player, GetName(), _cooldown, true, true))
		{
			return;
		}
