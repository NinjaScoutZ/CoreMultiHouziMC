package com.houzicore.arcade.nautilus.game.arcade.game.games.evolution;
...
import com.houzicore.arcade.nautilus.game.arcade.game.games.evolution.kits.*;
import com.houzicore.arcade.nautilus.game.arcade.game.games.evolution.mobs.*;
...
public class Evolution extends SoloGame
{
	...
	public Evolution(ArcadeManager manager) 
	{
		super(manager, GameType.Evolution,
				...
				new String[]
								{
				"[TH] You evolve when you get a kill.",
				"[TH] Each evolution has unique skills.",
				"",
				"[TH] First to get through 10 evolutions wins!"
								});
	...
	public void PlayerKillAward(PlayerDeathEvent event)
	{
		...
		final Player killer = UtilPlayer.searchExact(event.getEntity().getKiller().getName());
		if (killer == null)
			return;
