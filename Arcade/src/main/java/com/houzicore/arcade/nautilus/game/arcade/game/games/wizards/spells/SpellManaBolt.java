	...
	public void castSpell(final Player player)
	{
		...
		new BukkitRunnable()
		{
			...
			private void burst()
			{
				...
				missileLocation.getWorld().playSound(missileLocation, Sound.ENTITY_BAT_TAKEOFF, 1.2F, 1);
				cancel();
			}
			...
			public void run()
			{
				...
				else
				{
					...
					missileLocation.getWorld().playSound(missileLocation, Sound.ENTITY_EXPERIENCE_ORB_PICKUP, 0.7F, 0);
				}
			}
