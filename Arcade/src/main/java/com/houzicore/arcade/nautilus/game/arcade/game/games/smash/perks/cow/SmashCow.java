...
public class SmashCow extends SmashUltimate
{
	...
	public SmashCow()
	{
		super("Mooshroom Madness", new String[] {}, Sound.ENTITY_COW_AMBIENT, 0);
	}
	...
	public void activate(Player player)
	{
		...
		// Health
		player.getAttribute(Attribute.MAX_HEALTH).setBaseValue(_health);
		player.setHealth(_health);

		// Sound
		player.getWorld().playSound(player.getLocation(), Sound.ENTITY_COW_HURT, 5f, 0.25f);
