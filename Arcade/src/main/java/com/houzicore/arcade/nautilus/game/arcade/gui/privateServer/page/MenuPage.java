...
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.BanButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.EditRotationButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.GameVotingButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.GiveAdminButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.KillButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.PlayerHeadButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.RemoveAdminButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.SetGameButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.OptionsButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.StartGameButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.StopGameButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.UnbanButton;
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.WhitelistButton;
...
public class MenuPage extends BasePage
{
	...
	protected void buildPage()
	{
...

		{
			...
			ShopItem setGameItem = new ShopItem(Material.WRITABLE_BOOK, "Set Game", lore, 1, false);
		...
		if (host)
		{
			...
			addButton(4 + 9, hideInfo(new ShopItem(Material.DIAMOND_SWORD, "Give Admin", new String[]{}, 1, false)), giveAdminButton);

			RemoveAdminButton removeAdminButton = new RemoveAdminButton(getPlugin(), getShop());
			addButton(4 + 18, hideInfo(new ShopItem(Material.GOLDEN_SWORD, "Remove Admin", new String[]{}, 1, false)), removeAdminButton);
		...
		addButton(host ? 8 + 9 : 5 + 9, new ShopItem(Material.COMPARATOR, "Game Options", new String[]{}, 1, false), optionsButton);
		...
		// HouziCore style: fill ALL empty slots with glass panes
		com.houzicore.shared.common.util.GuiUtil.fillAllEmpty(getInventory(), Material.BLACK_STAINED_GLASS_PANE, " ");
	}

	private ShopItem getOwnerHead()
	{
		String title = C.cGreen + C.Bold + getPlugin().GetHost() + "'s Private Server";
