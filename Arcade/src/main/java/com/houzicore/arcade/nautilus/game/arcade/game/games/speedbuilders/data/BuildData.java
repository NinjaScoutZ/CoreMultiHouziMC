...
public class BuildData
{
	...
	public org.bukkit.block.data.type.Stairs.Shape[][][] StairShapes;
	...
	public BuildData(Location loc, String buildText, SpeedBuilders game)
	{
		...
		StairShapes = new org.bukkit.block.data.type.Stairs.Shape[game.BuildSize][game.BuildSize][game.BuildSize];
			...
			for (int y = 0; y < game.BuildSize; y++)
			{
				for (int z = 0; z < game.BuildSize; z++)
				{
					...
					if (block.getBlockData() instanceof org.bukkit.block.data.type.Stairs)
					{
						...
						StairShapes[x][y][z] = stairs.getShape();
					}
				}
			}
		}
