...
import com.houzicore.arcade.nautilus.game.arcade.game.games.searchanddestroy.kits.bow.*;
import com.houzicore.arcade.nautilus.game.arcade.game.games.searchanddestroy.kits.rogue.*;
import com.houzicore.arcade.nautilus.game.arcade.game.games.searchanddestroy.kits.trooper.*;
    ...
    public KitManager(SearchAndDestroy search)
    {
        ...
        // Register bow kits
        {
            ...
            children3.add(thunderstorm);
             ...
             // Register rogue kits
             {
                 ArrayList<UpgradeKit> rChildren1 = new ArrayList<UpgradeKit>();
                 ArrayList<UpgradeKit> rChildren2 = new ArrayList<UpgradeKit>();
                 ArrayList<UpgradeKit> rChildren3 = new ArrayList<UpgradeKit>();

                 UpgradeKit rogue1 = new UpgradeKit(null, new KitRogue(man), rChildren1, 4);
                 _kits.add(rogue1);
                 UpgradeKit rogue2 = new UpgradeKit(rogue1, new KitFlash(man), rChildren2, 20, 12);
                 _kits.add(rogue2);
                 UpgradeKit rogue3 = new UpgradeKit(rogue1, new KitEvade(man), rChildren3, 24, 14);
                 _kits.add(rogue3);
                 ...
                 _kits.add(rogue7);
                 rChildren1.add(rogue2);
                 rChildren1.add(rogue3);
                 rChildren2.add(rogue4);
                 rChildren2.add(rogue5);
                 rChildren3.add(rogue6);
                 rChildren3.add(rogue7);
