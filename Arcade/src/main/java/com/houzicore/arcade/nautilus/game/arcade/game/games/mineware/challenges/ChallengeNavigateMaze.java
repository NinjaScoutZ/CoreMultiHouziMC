			...
			for (int z = -12; z <= 15; z++)
			{
				...
				if (z == -12 || z == 15)
				{
					for (int y = 1; y <= 3; y++)
					{
						...
						// block.setData((byte) 0); // Block.setData removed in 1.21
						addBlock(block);
					}
				}
				...
				if (x > 15 || x < -12)
				{
					...
					// b.setData((byte) (x < 0 ? 14 : 13)); // Block.setData removed in 1.21
				}
				else
				{
					b.setType(Material.STONE);
					// b.setData((byte) 0); // Block.setData removed in 1.21
