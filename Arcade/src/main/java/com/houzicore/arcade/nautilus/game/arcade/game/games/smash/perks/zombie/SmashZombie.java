...
import com.houzicore.arcade.nautilus.game.arcade.kit.perks.data.NightLivingDeadData;
...
public class SmashZombie extends SmashUltimate
{
	...
	public SmashZombie()
	{
		super("Night of the Living Dead", new String[] {}, Sound.AMBIENT_CAVE, DURATION);
	}
	...
	public void update(UpdateEvent event)
	{
		...
		while (nightIter.hasNext())
		{
			...
			if (UtilTime.elapsed(data.LastSpawn, 1000))
			{
				...
				// Effect
				zombie.getWorld().playSound(zombie.getLocation(), Sound.ENTITY_ZOMBIE_AMBIENT, 1f, 0.75f);
