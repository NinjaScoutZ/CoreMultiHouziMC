...
// Manager.getDamager().AddThrow(ent, player, this, -1, true, true, true, false, 0.6f);
	...
	public void Collide(LivingEntity target, Block block, ProjectileUser data)
	{
		...
		//Effect
		data.GetThrown().getWorld().playSound(data.GetThrown().getLocation(), Sound.ENTITY_ZOMBIE_ATTACK_WOODEN_DOOR, 1f, 1.6f);
