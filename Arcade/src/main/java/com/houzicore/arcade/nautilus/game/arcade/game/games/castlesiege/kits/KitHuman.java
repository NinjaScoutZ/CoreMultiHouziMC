...
public abstract class KitHuman extends Kit
{
	...
	public KitHuman(ArcadeManager manager, String name, KitAvailability kitAvailability, String[] kitDescEn, String[] kitDescTh, Perk[] kitPerks, EntityType entityType, ItemStack itemInHand)
	{
		super(manager, name, kitAvailability, kitDescEn, kitDescTh, kitPerks, entityType, itemInHand);
	}

	public KitHuman(ArcadeManager manager, String name, KitAvailability kitAvailability, int cost, String[] kitDescEn, String[] kitDescTh, Perk[] kitPerks, EntityType entityType, ItemStack itemInHand)
	{
