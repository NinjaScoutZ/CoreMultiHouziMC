...
public class SpellRumble extends Spell implements SpellClickBlock, SpellClick
{
	...
	{
		if (event.getCause().name() != null && event.getCause().name().equals("Rumble"))
		{
   // /* event.AddKnockback(...) */;
		}
	}
	...
	private void playBlockEffect(Block block)
	{
		...
		fallingSpawn.i = 70;
		fallingSpawn.k = com.houzicore.shared.common.util.IdUtil.getTypeId(block) | com.houzicore.shared.common.util.IdUtil.getData(block) << 16;
