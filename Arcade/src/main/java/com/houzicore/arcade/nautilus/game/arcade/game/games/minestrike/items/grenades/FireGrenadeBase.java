package com.houzicore.arcade.nautilus.game.arcade.game.games.minestrike.items.grenades;
...
import com.houzicore.arcade.nautilus.game.arcade.game.games.minestrike.Radio;
...
public abstract class FireGrenadeBase extends Grenade
{
	...
	{
		//Sound
		loc.getWorld().playSound(loc, Sound.ENTITY_IRON_GOLEM_ATTACK, 1f, 1f);
