package com.houzicore.arcade.nautilus.game.arcade.game.games.sneakyassassins.npc;
...
import com.houzicore.arcade.nautilus.game.arcade.game.games.sneakyassassins.*;
...
//				continue;
		...
		if (UtilMath.offset(npc, bestTarget) < 1.5)
		{
			...
			npc.getWorld().playSound(npc.getLocation(), Sound.ENTITY_VILLAGER_NO, 1f, 1f);
		}
