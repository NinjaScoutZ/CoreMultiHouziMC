...
// Manager.getDamager().AddThrow(throwee, thrower, this, -1, true, false, true, false, 1f);
		...
		//Audio
		thrower.getWorld().playSound(thrower.getLocation(), Sound.ENTITY_SHEEP_AMBIENT, 2f, 3f);
	...
	public void Collide(LivingEntity target, Block block, ProjectileUser data)
	{
		...
		//Effect
		data.GetThrown().getWorld().playSound(data.GetThrown().getLocation(), Sound.ENTITY_SHEEP_AMBIENT, 3f, 5f);
	}
