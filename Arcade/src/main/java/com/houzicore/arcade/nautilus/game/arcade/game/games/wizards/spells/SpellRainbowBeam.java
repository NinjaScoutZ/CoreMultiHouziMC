...
public class SpellRainbowBeam extends Spell implements SpellClick
{
	...
	public void castSpell(Player p)
	{
		...
		if (entityTarget != null)
		{
			...
			p.playSound(entityTarget.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, (getSpellLevel(p) * 2) + 6, 1);
		...
		{
			l.getWorld().spawnParticle(org.bukkit.Particle.ENTITY_EFFECT, l, 1, 0, 0, 0, 0);
		}

		p.playSound(p.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, 1.5F, 1);
