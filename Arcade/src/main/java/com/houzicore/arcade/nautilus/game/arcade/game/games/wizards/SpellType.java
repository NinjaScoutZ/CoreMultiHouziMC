...
import com.houzicore.arcade.nautilus.game.arcade.game.games.wizards.spells.*;
...
{
	AnvilDrop(SpellElement.ATTACK, WandElement.EARTH, "Anvil Drop", new ItemStack(Material.STONE), null, 3, 40, 15, -3, -4, 10, "Dummy"),
	...
	Gust(SpellElement.MISC, // Spell element
			...
			"Gust", // Spell name
			new ItemStack(Material.GUNPOWDER), // Spell icon
	...
	IcePrison(SpellElement.MISC, WandElement.ICE, "Ice Prison", new ItemStack(Material.STONE), null, 3, 25, 20, 2, 0, 3, "Dummy"),
	...
	LightningStrike(SpellElement.ATTACK, // Spell element
			...
			new ItemStack(Material.INK_SAC, 1), // Spell icon
	...
	Napalm(SpellElement.ATTACK, WandElement.FIRE, "Napalm", new ItemStack(Material.STONE), null, 5, 60, 60, 5, -10, 1, "Dummy"),
	...
	SpectralArrow(SpellElement.ATTACK, WandElement.DEATH, "Spectral Arrow", new ItemStack(Material.STONE), null, 3, 40, 15, -5, -2, 3, "Dummy"),
	...
	{
		ATTACK(1, 0, 2, new ItemBuilder(Material.INK_SAC, 1, (short) 7).setTitle(C.cRed + "Attack Spells")
				.addLore(C.cGray + "Spells of destruction").build(), C.cRed),

		MISC(7, 6, 8, new ItemBuilder(Material.INK_SAC, 1, (short) 11).setTitle(C.cDGray + "Misc Spells").addLore(

		C.cGray + "Misc spells that don't fit in",

		"These spells generally effect the world itself").build(), C.cGray),

		SUPPORT(4, 4, 4, new ItemBuilder(Material.INK_SAC, 1, (short) 14).setTitle(C.cDGreen + "Support Spells")
