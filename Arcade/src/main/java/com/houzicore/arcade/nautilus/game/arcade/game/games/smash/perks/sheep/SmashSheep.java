package com.houzicore.arcade.nautilus.game.arcade.game.games.smash.perks.sheep;
...
import com.houzicore.arcade.nautilus.game.arcade.kit.perks.data.HomingSheepData;
...
public class SmashSheep extends SmashUltimate
{
	...
	public SmashSheep()
	{
		super("Homing Sheeples", new String[] {}, Sound.ENTITY_SHEEP_AMBIENT, 0);
	}
	...
	private void explode(HomingSheepData data)
	{
		...
		data.Sheep.getWorld().playSound(data.Sheep.getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 2f, 1f);
