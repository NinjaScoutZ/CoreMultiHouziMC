...
public class Gun extends StrikeItem
{
	...
	{
		loc.getWorld().playSound(loc, Sound.BLOCK_NOTE_BLOCK_HAT, 1f, 2f);
		loc.getWorld().playSound(loc, Sound.BLOCK_NOTE_BLOCK_HAT, 1f, 2f);
		loc.getWorld().playSound(loc, Sound.BLOCK_NOTE_BLOCK_HAT, 1f, 2f);
	}
	...
	{
		loc.getWorld().playSound(loc, Sound.BLOCK_PISTON_CONTRACT, 1f, 0.8f);
	}
	...
	public void handleReloaded(Player player)
	{
		...
		//Sound
		player.getWorld().playSound(player.getEyeLocation(), Sound.BLOCK_PISTON_EXTEND, 1f, 1.6f);
	}
