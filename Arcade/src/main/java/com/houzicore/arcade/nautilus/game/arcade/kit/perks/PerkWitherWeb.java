...
public class PerkWitherWeb extends Perk implements IThrown
{
	...
	public void ShootWeb(PlayerInteractEvent event)
	{
		...
		for (int i=0 ; i<40 ; i++)
		{
			org.bukkit.entity.Item ent = player.getWorld().dropItem(player.getEyeLocation().add(player.getLocation().getDirection()), ItemStackFactory.Instance.CreateStack(Material.COBWEB));
