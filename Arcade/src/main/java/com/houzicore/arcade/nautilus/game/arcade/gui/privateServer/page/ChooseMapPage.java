...
import com.houzicore.arcade.nautilus.game.arcade.gui.privateServer.button.ChooseMapButton;
...
public class ChooseMapPage extends BasePage
{
	...
	protected void buildPage()
	{
		...
		int slot = 9;
		for (String cur : getPlugin().LoadFiles(_gameType.GetMapFolderName())){
