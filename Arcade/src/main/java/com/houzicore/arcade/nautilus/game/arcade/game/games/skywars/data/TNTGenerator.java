...
import com.houzicore.arcade.nautilus.game.arcade.game.games.skywars.events.TNTPickupEvent;
...
public class TNTGenerator
{
	...
	public void pickup(Player player, Item item)
	{
		...
		player.playSound(player.getLocation(), Sound.ENTITY_ENDER_DRAGON_HURT, 3F, 1F);
