...
{	
	...
	public void Skill(PlayerInteractEvent event)
	{
		...
		//Projectile
// Manager.getDamager().AddThrow(item, player, this, -1, true, true, true, false, 0.6f);
	...
	{
		ent.getWorld().playSound(ent.getLocation(), Sound.ENTITY_ZOMBIE_ATTACK_IRON_DOOR, 0.6f, 0.5f);
