...
public class SmashGuardian extends SmashUltimate
{
	...
	{
		super("Rise of the Guardian", new String[] {}, Sound.ENTITY_LIGHTNING_BOLT_THUNDER, 0);
	}
	...
	public void cancel(Player player)
	{
		...
		while (iterator.hasNext())
		{
			...
			if (data.getPlayer().equals(player))
			{
				...
				player.getWorld().playSound(data.getTarget().getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 5, 0.5F);
