...
public class ChestLootPool
{
	...
	public void populateChest(Chest chest, List<Integer> slots)
	{
		...
		for (int i = 0; i < (_minimumPerChest + UtilMath.r(_maximumPerChest - _minimumPerChest + 1)); i++)
		{
			if (slots.isEmpty()) break;
			int slotIndex = UtilMath.r(slots.size());
	...
	public ItemStack getRandomItem()
	{
		...
		if (_enchantments.elements() != null && !_enchantments.elements().isEmpty() && Math.random() < _enchantmentRarity)
		{
