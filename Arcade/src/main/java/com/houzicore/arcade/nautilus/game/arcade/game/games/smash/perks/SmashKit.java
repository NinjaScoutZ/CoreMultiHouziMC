package com.houzicore.arcade.nautilus.game.arcade.game.games.smash.perks;
...
public abstract class SmashKit extends Kit
{
	...
	public void disguise(Player player, Class<? extends DisguiseInsentient> clazz)
	{
		...
		try
		{
			...
			// Disguise name and visibility are managed by DisguiseManager/DisguiseService natively
	...
	public String[] GetDesc()
	{
		if (_description == null)
		{
			...
			description.add(C.cGreen + "Kit - " + (C.cWhite + C.Bold) + GetName());
