...
{  
	...
	public String PurchaseString = "         " + com.houzicore.shared.core.common.BrandConfig.purchaseRank();
	...
	{
		ScoreboardString = "      " + com.houzicore.shared.core.common.BrandConfig.welcomeScoreboard(name);
	}
	...
	public String GetLastRankDisplay()
	{
		return _lastRankDisplay;
	}

	public void SetLastRankDisplay(String rankDisplay)
	{
		_lastRankDisplay = rankDisplay;
	}
