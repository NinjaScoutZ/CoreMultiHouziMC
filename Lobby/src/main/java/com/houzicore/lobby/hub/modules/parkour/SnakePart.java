...
public class SnakePart 
{
	...
	public SnakePart(ArrayList<Location> path)
	{
		...
		_color = com.houzicore.shared.common.util.IdUtil.getData(path.get(1).getBlock());
	...
	public void sendBlock(Location loc, int id, byte data)
	{
		...
		for (Player player : UtilServer.getPlayers())
		{
			...
			{
				// player.sendBlockChange(loc, Material.getMaterial(id), data); // getMaterial(int) removed in 1.21
			}
		}
	}
