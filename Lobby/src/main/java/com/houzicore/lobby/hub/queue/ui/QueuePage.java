...
import com.houzicore.lobby.hub.queue.PlayerMatchStatus;
...
public class QueuePage extends ShopPageBase<QueueManager, QueueShop>
{
			...
			if (matchStatus.AssignedMatch != -1)
			{
				if (matchStatus.State.equalsIgnoreCase("Ready"))
				{
					...
					for (String state : matchStatus.OtherStatuses)
					{
						...
						{
							setItem(i, new ShopItem(Material.WHITE_WOOL, "Waiting for reply...", new String[] { }, 1, false));
							_closeOnNextUpdate = false;
						}
						else if (state.equalsIgnoreCase("Denied"))
						{
							setItem(i, new ShopItem(Material.WHITE_WOOL, (byte)14, "Denied match.", new String[] { }, 1, false, false));
							_closeOnNextUpdate = false;
						}
						else if (state.equalsIgnoreCase("Ready"))
						{
							setItem(i, new ShopItem(Material.WHITE_WOOL, (byte)5, "Accepted match.", new String[] { }, 1, false, false));
	...
	private void drawCircle()
	{
		if (_circleIndex == 0)
		{
			setItem(3, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(15, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(41, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(29, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
		}
		else if (_circleIndex == 1)
		{
			setItem(4, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(24, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(40, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(20, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
		}
		else if (_circleIndex == 2)
		{
			setItem(5, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(33, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(39, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
			setItem(11, new ShopItem(Material.ENDER_EYE, "Beep", 1, false));
		}
	}
}
