...
public class UtilTrig {
	...
	public static ArrayList<Location> GetSpherePoints(Location loc, double radius, double height, boolean hollow,
			double addition) {
	...
	public static List<Vector> GetSpherePoints(Vector vector, double radius, double height, boolean hollow,
			double addition) {
