...
public class ZipUtil
{
	...
	public static void ZipFolders(String sourceFolder, String zipFilename, List<String> folders, List<String> files)
	{
		...
		catch (IOException e)
		{
			...
			if (fileInputStream != null)
			{
				...
				{
					org.bukkit.Bukkit.getServer().getLogger().log(java.util.logging.Level.SEVERE, e1.getMessage(), e1);
				}
			}
	...
	public static void UnzipToDirectory(String zipFilePath, String outputDirectory)
	{
		...
		try
		{
			...
			while ((entry = zipInputStream.getNextEntry()) != null)
			{
				...
				// Skip directory entries — just ensure the dir exists
	...
	/**
	 * Convenience alias — zip an entire directory to a single zip file.
	 * Delegates to ZipFolders with the source as both the base and target folder.
	 */
	public static void ZipDirectory(String sourceDirectory, String zipFilename)
	{
		java.util.List<String> folders = new java.util.ArrayList<String>();
		folders.add(sourceDirectory);
		ZipFolders(sourceDirectory, zipFilename, folders, new java.util.ArrayList<String>());
	}
}
