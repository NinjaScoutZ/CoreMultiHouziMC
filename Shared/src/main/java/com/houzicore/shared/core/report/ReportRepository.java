...
public class ReportRepository extends RepositoryBase {
	/*
	 * *ReportTicket id, date, accountId reported player, server, accountId of staff
	 * who closed, result, reason
	 * 
	 * ReportSenders id, date, reportId, accountId of Reporter, Reason for report
	 * 
	 * ReportHandlers id, date, reportId, accountId of Staff
	 * 
