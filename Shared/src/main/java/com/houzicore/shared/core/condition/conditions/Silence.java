package com.houzicore.shared.core.condition.conditions;
...
import com.houzicore.shared.core.condition.Condition;
...
public class Silence extends Condition
{
	...
	public void Add() 
	{
		if (_ent instanceof Player)
			((Player)_ent).playSound(_ent.getLocation(), org.bukkit.Sound.ENTITY_BAT_HURT, 0.8f, 0.8f);
	}
