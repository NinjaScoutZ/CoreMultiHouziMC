...
import com.houzicore.shared.core.condition.conditions.*;
...
public class ConditionFactory
{
			...
			double duration, boolean extend, boolean showIndicator)
	{
		return Manager.AddCondition(new Silence(Manager, reason, ent, source,  
				...
				Material.CLOCK, (byte)0, showIndicator));
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.INK_SAC, (byte)1, showIndicator, ambient)); 
	}
	...
	{	
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.INK_SAC, (byte)15, showIndicator, ambient)); 
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.INK_SAC, (byte)4, showIndicator, ambient)); 
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.WOODEN_PICKAXE, (byte)0, showIndicator, ambient)); 
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.CARROT, (byte)0, showIndicator, ambient)); 
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		...
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.SNOWBALL, (byte)0, showIndicator, ambient)); 
	}
	...
	*/
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean stun, boolean ambient)
	{
		...
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.COBWEB, (byte)0, showIndicator, ambient));
	}
	...
	{		
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				ConditionType.WITHER, mult, (int)(20 * duration), extend, 
				Material.PLAYER_HEAD, (byte)1, showIndicator, ambient)); 
	}
			...
			double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
	{
		return Manager.AddCondition(new Condition(Manager, reason, ent, source, 
				...
				Material.ENDER_EYE, (byte)0, showIndicator, ambient)); 
	}
