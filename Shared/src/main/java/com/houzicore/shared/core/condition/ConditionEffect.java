...
public class ConditionEffect implements Listener
{
	...
	public void Protection(CustomDamageEvent event)
	{
		...
		com.houzicore.shared.core.condition.Condition cond = Manager.GetActiveCondition(damagee, ConditionType.DAMAGE_RESISTANCE);
		if (cond == null)		return;
	...
	public void VulnerabilityDamagee(CustomDamageEvent event)
	{
		...
		com.houzicore.shared.core.condition.Condition cond = Manager.GetActiveCondition(damagee, ConditionType.WITHER);
		if (cond == null)		return;
	...
	public void VulnerabilityDamager(CustomDamageEvent event)
	{
		...
		com.houzicore.shared.core.condition.Condition cond = Manager.GetActiveCondition(damager, ConditionType.WITHER);
		if (cond == null)		return;
	...
	public void Strength(CustomDamageEvent event)
	{
		...
		com.houzicore.shared.core.condition.Condition cond = Manager.GetActiveCondition(damager, ConditionType.INCREASE_DAMAGE);
		if (cond == null)		return;
