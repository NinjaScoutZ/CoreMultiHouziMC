...
/**
 * The purpose of extracting stats to this class is so we can display stats that
 * are a combination of different stat values. For example, since we don't have
 * a specific stat for games played of a game, we can use this class to display
 * the stat "Games Played" that sums up "Wins" and "Losses" See:
