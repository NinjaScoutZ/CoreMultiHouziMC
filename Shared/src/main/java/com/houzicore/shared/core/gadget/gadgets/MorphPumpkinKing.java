...
public class MorphPumpkinKing extends MorphGadget {
	public MorphPumpkinKing(GadgetManager manager) {
		super(manager, "Pumpkin Kings Head",
				new String[] { C.cWhite + "Transforms the wearer into", C.cWhite + "the dreaded Pumpkin King!", "",
						C.cYellow + "Earned by defeating the Pumpkin King",
						C.cYellow + "in the 2013 Halloween Horror Event.", },
				-1, Material.PUMPKIN, (byte) 0);
	...
	public void EnableCustom(final Player player) {
		...
		final DisguiseSkeleton disguise = new DisguiseSkeleton(player);
		//disguise.showArmor();
