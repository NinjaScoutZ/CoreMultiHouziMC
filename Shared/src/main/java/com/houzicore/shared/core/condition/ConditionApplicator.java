...
public class ConditionApplicator
{
	...
	public ConditionApplicator() 
	{
		...
		_effectMap.put("Confusion", PotionEffectType.NAUSEA);
		_effectMap.put("DamageResist", PotionEffectType.RESISTANCE);
		_effectMap.put("FastDig", PotionEffectType.HASTE);
		_effectMap.put("FireResist", PotionEffectType.FIRE_RESISTANCE);
		_effectMap.put("Harm", PotionEffectType.INSTANT_DAMAGE);
		_effectMap.put("Heal", PotionEffectType.INSTANT_HEALTH);
		_effectMap.put("Hunger", PotionEffectType.HUNGER);
		_effectMap.put("Strength", PotionEffectType.STRENGTH);
		_effectMap.put("Jump", PotionEffectType.JUMP_BOOST);
		_effectMap.put("Poison", PotionEffectType.POISON);
		_effectMap.put("Regeneration", PotionEffectType.REGENERATION);
		_effectMap.put("Slow", PotionEffectType.SLOWNESS);
		_effectMap.put("SlowDig", PotionEffectType.MINING_FATIGUE);
