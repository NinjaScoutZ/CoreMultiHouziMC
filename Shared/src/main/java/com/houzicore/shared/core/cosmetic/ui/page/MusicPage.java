...
public class MusicPage extends GadgetPage {
	public MusicPage(CosmeticManager plugin, CosmeticShop shop, CoreClientManager clientManager,
	...
	protected void buildPage() {
		...
		if (getPlugin().getGadgetManager().getGadgets(GadgetType.MusicDisc) != null) {
			gadgets.addAll(getPlugin().getGadgetManager().getGadgets(GadgetType.MusicDisc));
		}
