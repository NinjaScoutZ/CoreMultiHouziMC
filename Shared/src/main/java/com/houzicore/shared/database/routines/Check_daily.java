...
public class Check_daily extends org.jooq.impl.AbstractRoutine<java.lang.Void> implements java.io.Serializable, java.lang.Cloneable {
	 ...
	 */
	public Check_daily() {
		super("check_daily", com.houzicore.shared.database.Account.Account);
	...
	public void setAccountId_in(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_daily.accountId_in, value);
	}
	...
	public void setCoinsChange(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_daily.coinsChange, value);
	}
	...
	public void setGemsChange(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_daily.gemsChange, value);
	}
