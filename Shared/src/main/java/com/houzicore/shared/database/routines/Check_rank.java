...
public class Check_rank extends org.jooq.impl.AbstractRoutine<java.lang.Void> implements java.io.Serializable, java.lang.Cloneable {
	 ...
	 */
	public Check_rank() {
		super("check_rank", com.houzicore.shared.database.Account.Account);
	...
	public void setAccountId_in(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_rank.accountId_in, value);
	}
	...
	public void setCoinsChange(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_rank.coinsChange, value);
	}
	...
	public void setGemsChange(java.lang.Integer value) {
		setValue(com.houzicore.shared.database.routines.Check_rank.gemsChange, value);
	}
