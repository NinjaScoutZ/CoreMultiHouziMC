...
public class PlayerLogin extends org.jooq.impl.AbstractRoutine<java.lang.Void> implements java.io.Serializable, java.lang.Cloneable {
	 ...
	 */
	public PlayerLogin() {
		super("playerLogin", com.houzicore.shared.database.Account.Account);
	...
	public void setParamUuid(java.lang.String value) {
		setValue(com.houzicore.shared.database.routines.PlayerLogin.paramUuid, value);
	}
	...
	public void setParamName(java.lang.String value) {
		setValue(com.houzicore.shared.database.routines.PlayerLogin.paramName, value);
	}
}
