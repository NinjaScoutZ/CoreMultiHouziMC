package com.houzicore.bungeecord.motd;
...
public class MotdManager implements Listener, Runnable
{
	...
	private String _firstLine = "§8§l[§b§lʜᴏᴜᴢɪ§3§lᴄᴏʀᴇ§8§l] §fThe Ultimate Experience";
	...
	public MotdManager(Plugin plugin)
	{
		...
		if (new File("updateMOTD.dat").exists())
		{
			...
			lines.add("  §a✦ Block Hunt §7| §bArcade §7| §6Treasure §7| §cMore!");
			
			updateMainMotd("§8§l[§b§lʜᴏᴜᴢɪ§3§lᴄᴏʀᴇ§8§l] §fThe Ultimate Experience", lines);
			new File("updateMOTD.dat").delete();
		}
	}
